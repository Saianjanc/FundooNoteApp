...
function TakeNote(){
    return (
        <div className="w-[600px] h-[135.6px] border-gray-400 rounded-lg border-2 relative m-[10px]">
            <div className='pt-[10px] pr-[10px] pl-[10px] pb-[4px]'>
            <input type='text' className="w-full mb-[4px] text-base font-medium leading-6 pt-3; font-family: 'Google Sans', Roboto, Arial, sans-serif outline-none" placeholder='Title' />
            <textarea className="h-full w-full font-normal leading-5; font-family: Roboto, Arial, sans-serif resize-none outline-none" placeholder='Take Note...'/>
            </div>
            ...
            <Button variant="text" className='!normal-case'>Close</Button>
            </div>
